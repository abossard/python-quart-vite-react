...
import SupportTicket from './features/support/SupportTicket'
...
export default function App() {
  ...
  const tabs = [
    ...
    { value: 'support', label: 'Support Ticket', icon: <TicketDiagonalRegular />, path: '/support-ticket', testId: 'tab-support' },
